    ...
    if (file) {
      try {
        ...
        const resFile = await axios({
          ...
          data: formData,
          headers: {
            pinata_api_key: `44178ac1dae0a8cf22b0`,
            pinata_secret_api_key: `47531c4834a686be43017863dc205ec124c3cc92757ba1bb63bacd42661d3c3b`,
        ...
        //const ipfsHash = `ipfs://${resFile.data.IpfsHash}`; // Assuming resFile.data.IpfsHash contains the correct IPFS hash

// Check if IPFS daemon is running and IPFS hash is valid
// if (ipfsHash.startsWith('ipfs://')) {
//     const signer = contract.connect(provider.getSigner());
//     signer.add(account, ipfsHash);
// } else {
//     console.error('Invalid IPFS hash or link format');
// }
